...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "رفيق التغذية الذكي" },
      { name: "description", content: "تتبّع سعراتك وماكروزك وفيتاميناتك وحقّق هدف وزنك مع رفيق التغذية الذكي" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;700&family=Tajawal:wght@500;700&display=swap",
      },
    ],
  }),
